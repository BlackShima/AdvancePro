package se233.chapter6_ex2.controller;

import javafx.scene.control.Alert;
import javafx.scene.control.TextInputDialog;
import se233.chapter6_ex2.Launcher;
import se233.chapter6_ex2.model.Currency;
import se233.chapter6_ex2.model.CurrencyEntity;
        ...
        while (true) {
            try {
                ...
                if (code.isPresent() && !code.get().isEmpty()) {
                    ...
                    logger.info("Adding new currency: {}", code.get());
